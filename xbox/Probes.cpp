...
void RunProbe(Test& test, std::wstring const& executablePath, std::wstring const& directory) {
    ...
    test.measurements.Insert(L"sysv_abi_passed", JsonValue::CreateBooleanValue(execution.sysv_abi_passed));
    test.measurements.Insert(L"sysv_abi_returned_value", JsonValue::CreateNumberValue(static_cast<double>(execution.sysv_abi_returned_value)));
