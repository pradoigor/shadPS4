...
A versão **0.17.0.0** inclui biblioteca horizontal inspirada no PS4, importação de
...
(`sceKernelUsleep` e `sysKernelGetUpdVersion`); imports restantes retornam
`ENOSYS` e continuam bloqueados pelo gate.
