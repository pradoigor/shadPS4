...
A versão **0.19.0.0** inclui biblioteca horizontal inspirada no PS4, importação de
...
demais; esses endereços ainda não são gravados nas relocações do convidado.
