...
A versão **0.20.0.0** inclui biblioteca horizontal inspirada no PS4, importação de
...
demais. O probe aplica os endereços em uma cópia privada não executável para
